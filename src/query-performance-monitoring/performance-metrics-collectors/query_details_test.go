...
func (m *MockDataSource) QueryxContext(app *newrelic.Application, ctx context.Context, query string, args ...interface{}) (*sqlx.Rows, error) {
	...
	return arguments.Get(0).(*sqlx.Rows), arguments.Error(1)
}
...
func TestCollectGroupedSlowQueryMetrics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defer db.Close()
			metrics, queryIDList, err := collectGroupedSlowQueryMetrics(nil, mockDataSource, tt.fetchInterval, tt.queryCountThreshold, []string{})
...
func TestCollectIndividualQueryMetrics(t *testing.T) {
	...
	runCollectIndividualQueryMetricsTest := func(name string, queryIDList []string, expectedError error, expectedMetrics []utils.IndividualQueryMetrics) {
		t.Run(name, func(t *testing.T) {
			...
			actualMetrics, err := collectIndividualQueryMetrics(nil, mockDB, queryIDList, queryString, args)
...
func TestExtensiveQueryMetrics(t *testing.T) {
	...
	runExtensiveQueryMetricsTest := func(name string, queryIDList []string, expectedError error, expectedMetrics []utils.IndividualQueryMetrics) {
		t.Run(name, func(t *testing.T) {
			...
			actualMetrics, err := extensiveQueryMetrics(nil, mockDB, queryIDList, args)
			if expectedError != nil {
				assert.Error(t, err)
...
func TestPopulateSlowQueryMetrics(t *testing.T) {
	...
	t.Run("Failure to collect slow query metrics", func(t *testing.T) {
		...
		queryIDList := PopulateSlowQueryMetrics(nil, mockIntegration.Integration, mockDB, args, excludedDatabases)
