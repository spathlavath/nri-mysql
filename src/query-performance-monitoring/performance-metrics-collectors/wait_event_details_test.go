...
func (ds *DataSource) QueryxContext(app *newrelic.Application, ctx context.Context, query string, args ...interface{}) (*sqlx.Rows, error) {
...
func TestPopulateWaitEventMetrics(t *testing.T) {
	...
	PopulateWaitEventMetrics(nil, dataSource, i, args, excludedDatabases)
