...
func TestSetBlockingQueryMetrics(t *testing.T) {
	...
	metrics := []datamodels.BlockingSessionMetrics{
		{
...
func TestPopulateBlockingSessionMetrics_QueryError(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta(query)).WithArgs(sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg()).WillReturnError(fmt.Errorf("query execution error"))
