...
integration-test:
	...
	@go test -v -tags=integration ./tests/integration/. || (ret=$$?; docker compose -f tests/integration/docker-compose.yml down && docker compose -f tests/integration/docker-compose-performance.yml down && exit $$ret)
	@docker compose -f tests/integration/docker-compose.yml down
	@docker compose -f tests/integration/docker-compose-performance.yml down
